...
public final class ReactFrontCameraSession: NSObject, ObservableObject {
...
extension ReactFrontCameraSession: AVCaptureFileOutputRecordingDelegate {
    public func fileOutput(
        ...
        let completion = self.onRecordingFinished
...
public struct FrontCameraPreview: View {
